...
type Ownership_for_String struct {
	...
	PendingExpiry Expiration `json:"pending_expiry"`
...
type ChannelOpenInitOptions struct {
	...
	ChannelOrdering IbcOrder `json:"channel_ordering"`
...
type State struct {
	...
	CallbackAddress Addr `json:"callback_address"`
