...
const (
	...
	TxEncoding_Proto3_Value TxEncoding = "proto3"
	// `Proto3Json` is the json serialization of the CosmosSDK's Any.
	TxEncoding_Proto3Json_Value TxEncoding = "proto3json"
)
