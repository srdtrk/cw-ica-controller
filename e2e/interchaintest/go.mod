module github.com/srdtrk/cw-ica-controller/interchaintest/v2
...
require (
	...
	github.com/strangelove-ventures/interchaintest/v7 v7.0.0-20230612202401-9723cdf4b7e6
...
// use json encoding branch
replace github.com/cosmos/ibc-go/v7 => github.com/cosmos/ibc-go/v7 v7.0.0-20230608165848-4e18badc5af4
